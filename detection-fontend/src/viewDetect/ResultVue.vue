<template>
  <div class="container">
    <div>
      <div class="content-title">模型记录查询</div>
...
<!--        </el-table-column>-->
    ...
    <div class="content-title">图片记录查询</div>
    <div class="handle-box">
...
<!--      </el-button>-->
    ...
    <div class="content-title">检测记录查询</div>

    <div class="handle-box">
      <el-input v-model="result_query.keyword" placeholder="结果名称" class="handle-input mr10"></el-input>
      <el-button type="default" :icon="Search " @click="handleResultSearch">搜索</el-button>

      <el-button type="default"  @click="handleResultAll">
        <el-icon><List /></el-icon>
        <span>列出结果</span>
      </el-button>
    </div>
    ...
    <el-table :data="resultData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
      ...
      <el-table-column label="操作" width="300" align="center">
        <template #default="scope">
          <el-button text :icon="TopLeft" class="green" @click="handleResultDetail(scope.row)" v-permiss="15">
            查看
          </el-button>
    ...
    <el-dialog title="结果细节" v-model="objDetail" width="70%" class="content-title">
      ...
      <el-descriptions :column="3" border>
        ...
        <el-descriptions-item label="模型类别" label-align="right" align="center">
          <el-tag size="middle" type="default">{{model_params.model_type}}</el-tag>
        </el-descriptions-item>
