  ...
  <div class="container">
    ...
    <div class="plugins-tips">
      ...
      <p style="line-height: 30px">
        上传文件需得是pt格式的，如果不是请用python进行格式转换或者重新训练
      </p>
      <p style="line-height: 30px">
        模型名称不能重复
      </p>
    ...
    <div class="form-box">
      ...
      <el-form ref="formRef" :model="AddModelForm" label-width="80px" :rules="rules">
        ...
        <el-form-item label="模型类别" prop="model_type" label-width="150px">
          <el-select v-model="AddModelForm.model_type" placeholder="请选择">
              <el-option key="Detr" label="Detr" value="Detr"></el-option>
              <el-option key="YOLO" label="yolo" value="yolo"></el-option>
			  <el-option key="Fast-RCNN" label="Fast-RCNN" value="Fast-RCNN"></el-option>
			  <el-option key="Mobilenetv3" label="Mobilenet" value="Mobilenet"></el-option>
			  <el-option key="VGG-16" label="VGG-16" value="VGG-16"></el-option>
          </el-select>
        </el-form-item>

        <el-form-item label="数据集名称" prop="model_dataset" label-width="150px">
        ...
        <el-form-item label-width="150px" label="操作">
          <el-button type="default" @click="handleModelPost(AddModelForm)">模型提交</el-button>
          <el-button type="default" @click="handleModelFormReset">模型撤回</el-button>
        </el-form-item>
    ...
    <div>
      <el-descriptions :column="3" border title="当前选用的模型">
        ...
        <el-descriptions-item label="模型类别" label-align="right" align="center">
          <el-tag size="middle" type="danger">{{model_params.model_type}}</el-tag>
        </el-descriptions-item>

        <el-descriptions-item label="数据集名称" label-align="right" align="center">
    ...
    <div>
      ...
      <div class="handle-box">
        ...
        <el-button type="default" :icon="Search " @click="handleModelSearch">搜索</el-button>

        <el-button type="default"  @click="handleModelAll">
...
<!--            </el-button>-->
      ...
      <div class="handle-box">
        ...
        <el-button type="default" :icon="Search " @click="handleSearch">搜索</el-button>
...
<!--        </el-button>-->
        ...
        <el-button type="default"  @click="handleAll">
          <el-icon><List /></el-icon>
          <span>搜索全部</span>
        </el-button>
      </div>
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
        ...
        <el-table-column label="操作" width="220" align="center">
          <template #default="scope">
            <el-button text :icon="Search" class="red" @click="detection(scope.$index, scope.row)" v-permiss="16">
              检测
            </el-button>
          </template>
        </el-table-column>
...
const detection = (index: number, row: any) => {
  ...
  axios({ // 首先执行检测任务，生成结果图片
    ...
    console.log("res"+res1.data.status)
