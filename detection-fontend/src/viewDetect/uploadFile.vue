<template>
  <div class="container">
    ...
    <div>
      ...
      <el-button type="default"  @click="uploadURL(url)">
        <el-icon><Upload /></el-icon>
        <span>上传</span>
      </el-button>
    </div>

    <div class="content-title">查找图片</div>
    <div class="handle-box">
      <el-input v-model="query.keyword" placeholder="输入图片名称" class="handle-input mr10"></el-input>
